...
define i32 @usat_add_i32(i32 %a, i32 %b) {
entry:
  %r = call i32 @llvm.uadd.sat.i32(i32 %a, i32 %b)
  ret i32 %r
}

define i32 @usat_sub_i32(i32 %a, i32 %b) {
entry:
...
; TC2X-LABEL: usat_add_i32:
; TC2X: adds.u %d2, %d4, %d5
; TC2X: ret

; TC2X-LABEL: usat_sub_i32:
; TC2X: subs.u %d2, %d4, %d5
; TC2X: ret
