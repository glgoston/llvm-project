...
public:
  ...
  unsigned encodeMemSrcValue(const MCInst &MI, unsigned OpIdx,
                             SmallVectorImpl<MCFixup> &Fixups,
                             const MCSubtargetInfo &STI) const;
...
MCCodeEmitter *llvm::createTriCoreMCCodeEmitter(const MCInstrInfo &II,
                                                MCContext &Ctx) {
  return new TriCoreMCCodeEmitter(II, Ctx);
}

unsigned
TriCoreMCCodeEmitter::encodeCallTarget(const MCInst &MI, unsigned OpNo,
                                       SmallVectorImpl<MCFixup> &Fixups,
                                       const MCSubtargetInfo &STI) const {
...
unsigned
TriCoreMCCodeEmitter::encodeMemSrcValue(const MCInst &MI, unsigned OpIdx,
                                        SmallVectorImpl<MCFixup> &Fixups,
                                        const MCSubtargetInfo &STI) const {
